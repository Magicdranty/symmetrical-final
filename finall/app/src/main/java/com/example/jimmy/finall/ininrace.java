...
public class ininrace extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ininrace);
        ////
        ...
        connectuse con = (connectuse) ininrace.this.getApplication();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_ininrace, menu);
        return true;
    }
    ...
    public void jump() {
        Intent it = new Intent(ininrace.this, ininranking.class);
    ...
    public void dia()
    {
        new AlertDialog.Builder(ininrace.this)
                .setTitle("警告")
                ...
                .setPositiveButton("是", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent it=new Intent(ininrace.this,ininreal.class);
